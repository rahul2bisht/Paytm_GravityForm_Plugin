...
class GFPaytmFormData{
    ...
    public static function insert_transaction($entry_id, $transaction_type, $transaction_id, $parent_transaction_id, $amount){
        ...
        if(!$existing_transaction_id){
            ...
            $sql = $wpdb->prepare(" INSERT INTO $table_name (entry_id, transaction_type, transaction_id, parent_transaction_id, amount, is_renewal, date_created) values(%d, %s, %s, %s, %f, %d, utc_timestamp())", $entry_id, $transaction_type, $transaction_id, $parent_transaction_id, $amount, $is_renewal);
            $wpdb->query($sql);
            $id = $wpdb->insert_id;
        }
        else{
    ...
    public static function get_paytm_form_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_paytm_form";
    }

    public static function get_transaction_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_paytm_form_transaction";
    }
    ...
    public static function get_feed_by_form($form_id, $only_active = false){
        ...
        return apply_filters("gform_paytm_form_get_feeds_{$form_id}", apply_filters('gform_paytm_form_get_feeds', $results, $form_id), $form_id);
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_paytm_form_table_name());
    }
